#############################################################################
# Makefile for building: Ballspeed
# Generated by qmake (3.0) (Qt 5.1.1) on: Wed Nov 6 14:47:13 2013
# Project:  Ballspeed.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile Ballspeed.pro
#############################################################################
...
LIBS          = $(SUBLIBS) `pkg-config --libs opencv` -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		videoframe.cpp \
		hough.cpp \
		subimage.cpp moc_mainwidget.cpp \
		moc_videoframe.cpp
OBJECTS       = main.o \
		mainwidget.o \
		template.o \
...
Makefile: Ballspeed.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Ballspeed.pro
...
dist: 
	@test -d .tmp/Ballspeed1.0.0 || mkdir -p .tmp/Ballspeed1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Ballspeed1.0.0/ && $(COPY_FILE) --parents mainwidget.h template.h ui_ui.h videoframe.h hough.h subimage.h .tmp/Ballspeed1.0.0/ && $(COPY_FILE) --parents main.cpp mainwidget.cpp template.cpp videoframe.cpp hough.cpp subimage.cpp .tmp/Ballspeed1.0.0/ && $(COPY_FILE) --parents ui.ui .tmp/Ballspeed1.0.0/ && (cd `dirname .tmp/Ballspeed1.0.0` && $(TAR) Ballspeed1.0.0.tar Ballspeed1.0.0 && $(COMPRESS) Ballspeed1.0.0.tar) && $(MOVE) `dirname .tmp/Ballspeed1.0.0`/Ballspeed1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Ballspeed1.0.0
...
compiler_moc_header_make_all: moc_mainwidget.cpp moc_videoframe.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwidget.cpp moc_videoframe.cpp
moc_mainwidget.cpp: /usr/include/qt/QtWidgets/QWidget \
...
moc_videoframe.cpp: /usr/include/qt/QtWidgets/QLabel \
		...
		hough.h \
		videoframe.h
	/usr/lib/qt/bin/moc $(DEFINES) $(INCPATH) -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.8.2/../../../../include/c++/4.8.2 -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.8.2/../../../../include/c++/4.8.2/x86_64-unknown-linux-gnu -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.8.2/../../../../include/c++/4.8.2/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.8.2/include -I/usr/local/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.8.2/include-fixed -I/usr/include videoframe.h -o moc_videoframe.cpp
...
compiler_uic_clean:
	-$(DEL_FILE) ui_ui.h
ui_ui.h: ui.ui
	/usr/lib/qt/bin/uic ui.ui -o ui_ui.h
...
hough.o: hough.cpp hough.h \
		...
		/usr/include/qt/QtCore/qregexp.h \
		/usr/include/qt/QtCore/qstringmatcher.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o hough.o hough.cpp

subimage.o: subimage.cpp subimage.h \
		/usr/include/qt/QtCore/QPoint \
		/usr/include/qt/QtCore/qpoint.h \
		/usr/include/qt/QtCore/qnamespace.h \
		/usr/include/qt/QtCore/qglobal.h \
		...
		/usr/include/qt/QtCore/qregexp.h \
		/usr/include/qt/QtCore/qstringmatcher.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o subimage.o subimage.cpp

moc_mainwidget.o: moc_mainwidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_mainwidget.o moc_mainwidget.cpp

moc_videoframe.o: moc_videoframe.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_videoframe.o moc_videoframe.cpp
